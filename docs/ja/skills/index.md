...
| [Tradingview Analyzer]({{ '/ja/skills/tradingview-analyzer/' | relative_url }}) | Use when the user asks for TradingView technical analysis, indicator data, screener scans, or provides TradingView ch... | <span class="badge badge-free">API不要</span> |
