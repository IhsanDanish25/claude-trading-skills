...
| [Breakout Scanner]({{ '/en/skills/breakout-scanner/' | relative_url }}) | Scan for stocks breaking out of consolidation ranges on above-average volume | <span class="badge badge-free">No API</span> |
...
| [Buffett Value]({{ '/en/skills/buffett-value/' | relative_url }}) | Screen for Buffett-style value stocks using business quality, consistency, and valuation filters with candlestick ent... | <span class="badge badge-free">No API</span> |
...
| [Earnings Momentum Tracker]({{ '/en/skills/earnings-momentum-tracker/' | relative_url }}) | Track post-earnings price momentum continuation for stocks that gapped up or down on earnings | <span class="badge badge-free">No API</span> |
...
| [Insider Buying Detector]({{ '/en/skills/insider-buying-detector/' | relative_url }}) | Detect significant insider buying activity (CEO, CFO, directors purchasing company stock in the open market) | <span class="badge badge-free">No API</span> |
...
| [Macro Signal Monitor]({{ '/en/skills/macro-signal-monitor/' | relative_url }}) | Monitor cross-asset macro signals including yield curve shape, DXY trend, VIX regime, commodity momentum (gold, oil),... | <span class="badge badge-free">No API</span> |
...
| [Mean Reversion Screener]({{ '/en/skills/mean-reversion-screener/' | relative_url }}) | Screen for oversold stocks with high mean reversion probability using RSI, Bollinger Band position, and distance from... | <span class="badge badge-free">No API</span> |
| [News Sentiment Analyzer]({{ '/en/skills/news-sentiment-analyzer/' | relative_url }}) | Analyze news sentiment for stocks or market themes using NLP scoring | <span class="badge badge-free">No API</span> |
| [Options Flow Scanner]({{ '/en/skills/options-flow-scanner/' | relative_url }}) | Scan for unusual options activity and large institutional options flow | <span class="badge badge-free">No API</span> |
...
| [Sector Rotation Detector]({{ '/en/skills/sector-rotation-detector/' | relative_url }}) | Detect sector rotation by measuring relative momentum across all 11 SPDR sector ETFs (XLK, XLV, XLF, XLE, XLI, XLY, X... | <span class="badge badge-free">No API</span> |
| [Short Squeeze Scanner]({{ '/en/skills/short-squeeze-scanner/' | relative_url }}) | Identify potential short squeeze candidates by combining high short interest, low float, rising price momentum, and i... | <span class="badge badge-free">No API</span> |
...
| [Technical Indicator Suite]({{ '/en/skills/technical-indicator-suite/' | relative_url }}) | Calculate RSI, MACD, Bollinger Bands, ATR, and EMA for any stock or ETF | <span class="badge badge-free">No API</span> |
